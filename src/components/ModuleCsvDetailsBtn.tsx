import { Box, Button, Tooltip, Typography, useTheme, lighten, darken, Link } from "@mui/material";
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0.5 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 1, alignItems: 'center' }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="body2" sx={{ fontWeight: 'bold', mr: 1, display: 'flex', alignItems: 'center' }}>
              {t('CSVTH_PARTNER_WWW')}:
            </Typography>
          </Box>
          <Link href={"https://" + CSVTH_PARTNER_WWW} target="_blank" rel="noopener noreferrer" variant="body2" sx={{ color: mode === 'light' ? darken(theme.palette.primary.main, 0.22) : lighten(theme.palette.primary.main, 0.3), cursor: 'pointer', display: 'flex', alignItems: 'center', textDecoration: 'none', '&:hover': { textDecoration: 'underline', color: mode === 'light' ? darken(theme.palette.primary.main, 0.22) : lighten(theme.palette.primary.main, 0.3) } }}>
            {CSVTH_PARTNER_WWW ?? '-'}
          </Link>
        </Box>
      </Box>
